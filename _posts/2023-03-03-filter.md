...
Consider an image defined by the function $f(x, y):\Omega \mapsto \R$ where $\Omega \subseteq \R^2$. For simplicity, we consider a 1 channel image, e.g., a real-valued grayscale image. <font face="Noto Serif SC">两个坐标指向一个像素点的位置中包含的灰度值（简单起见）。</font>
...
$$
g(x, y) = \{f*h \}(x, y) = \int\int^{\infin}_{-\infin}f(x', y')h(x-x', y-y')dx'dy'
$$
...
**Note:** We also need to assume that both functions are square-integrable, $\int\int_{-\infin}^{\infin}|f(x, y)|^2dxdy < \infin$.
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214203115471.png" alt="image-20230214203115471" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214203919061.png" alt="image-20230214203919061" style="zoom:50%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214204407238.png" alt="image-20230214204407238" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214215124119.png" alt="image-20230214215124119" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214221441449.png" alt="image-20230214221441449" style="zoom: 67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214221830753.png" alt="image-20230214221830753" style="zoom:50%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214224552142.png" alt="image-20230214224552142" style="zoom:67%;" />
...
$$
g(x, y) = \{f * h \}(x, y) = \int^{\infin}_{-\infin}\int^{\infin}_{-\infin} f(x', y')h(x-x', y-y')dx'dy'
$$
The correlation integral
$$
g(x, y) = \{f \circ h \}(x, y) = \int^{\infin}_{-\infin}\int^{\infin}_{-\infin}f(x', y')h(x+x', y+y')dx'dy'
$$
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230214235420981.png" alt="image-20230214235420981" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215010124607.png" alt="image-20230215010124607" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215015059514.png" alt="image-20230215015059514" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215020100219.png" alt="image-20230215020100219" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215020534578.png" alt="image-20230215020534578" style="zoom:67%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215022513358.png" alt="image-20230215022513358" style="zoom: 50%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215023411930.png" alt="image-20230215023411930" style="zoom: 50%;" />
...
<img src="/Users/liuying/Library/Application Support/typora-user-images/image-20230215024415227.png" alt="image-20230215024415227" style="zoom: 50%;" />
