...
$$
g(x, y) = \int^{\infity}_{-\infity}\int^{\infity}_{-\infity}f(x', y')h(x-x', y-y')dx'dy'
$$
...
$$
g(x, y) = \{f*h \}(x, y) = \int\int^{\infity}_{-\infity}f(x', y')h(x-x', y-y')dx'dy'
$$
...
**Note:** We also need to assume that both functions are square-integrable, $\int\int_{-\infity}^{\infity}|f(x, y)|^2dxdy < \infity$.
...
$$
g(x, y) = \{f * h \}(x, y) = \int^{\infity}_{-\infity}\int^{\infity}_{-\infity} f(x', y')h(x-x', y-y')dx'dy'
$$

The correlation integral

$$
g(x, y) = \{f \circ h \}(x, y) = \int^{\infity}_{-\infity}\int^{\infity}_{-\infity}f(x', y')h(x+x', y+y')dx'dy'
$$
